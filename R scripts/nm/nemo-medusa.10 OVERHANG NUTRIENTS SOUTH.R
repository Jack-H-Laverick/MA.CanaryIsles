...
future_map(PTRC_files, NEMO_MEDUSA, analysis = "slabR",                        # Interpolate grid_W files in paralell
           out_dir = "./Objects/overhang nutrient SOUTH", scheme = scheme,
...
W_files <- list.files("./Objects/overhang SOUTH/", full.names = TRUE)
ptrc_files <- list.files("./Objects/overhang nutrient SOUTH/", full.names = TRUE)

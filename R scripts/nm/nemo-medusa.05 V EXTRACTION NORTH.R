...
# saveRDS("./Objects/vertical boundary NORTH/.")  # Marker so network script can see where the data is being saved too, it's buried in a function
...
future_map(W_files, NEMO_MEDUSA, analysis = "slabR",                        # Interpolate grid_W files in paralell
           out_dir = "./Objects/vertical boundary NORTH", scheme_w = scheme,

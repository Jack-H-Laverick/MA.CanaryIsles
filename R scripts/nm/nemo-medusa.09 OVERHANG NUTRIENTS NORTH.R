...
future_map(PTRC_files, NEMO_MEDUSA, analysis = "slabR",                        # Interpolate grid_W files in paralell
           out_dir = "./Objects/overhang nutrient NORTH", scheme = scheme,
...
W_files <- list.files("./Objects/overhang NORTH/", full.names = TRUE)
ptrc_files <- list.files("./Objects/overhang nutrient NORTH/", full.names = TRUE)

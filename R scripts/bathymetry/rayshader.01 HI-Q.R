...
S <- nrow(nc_lat)*(90+25.5)/180 ; N <- nrow(nc_lat)*(90+30.5)/180
W <- length(nc_lon)*(180-20)/360 ; E <- length(nc_lon)*(180-12)/360     # For Mercatore
...
render_highquality(print_scene_info = T, parallel = TRUE, lightintensity = 0, samples = 3500, filename = "rayshade-hi.png", 
                   scene_elements = bind_rows(rayrender::sphere(z = 100, y = 2000, x = 600, radius = 50,
                                              ...
                                              rayrender::text3d(label = "The Canaries", angle = c(-30, 60, 0), z = 2000, y = -50, x = -650, 
